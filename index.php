                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <fieldset id="fromFileds">
                                                    <div class="form-group">
                                                        <label for="fromSelectCountry">Country:</label>
                                                        <?php if (isset($countries)) { ?>
                                                            <select class="form-control" id="fromSelectCountry">
                                                    ...
                                                    <label class="fancy-radio">
                                                        <input name="usedFor" value="Residential" type="radio">
                                                        <span><i></i>Residential</span>
                                                    </label>
                                                </fieldset>
                                            </div>
                                            <div class="col-md-6">
                                                ...
                                                <fieldset id="toFileds">
                                                    <div class="form-group">
                                                        <label for="toSelectCountry">Country:</label>
                                                        <?php if (isset($countries)) { ?>
                                                            <select class="form-control" id="toSelectCountry">
                                                                <?php foreach ($countries as $country) { ?>
                                                                    <option value="<?= $country->code; ?>"><?= $country->name; ?></option>
                                                                <?php }//endloop categories dropdown ?>
                                                            </select>
                                                    ...
                                                    <label class="fancy-radio">
                                                        <input name="usedFor" value="Business" type="radio">
                                        ...
                                        <div class="panel-body row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input required type="text" class="form-control" id="length" name="length">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="width">Width(in.):</label>
                                                    <input required type="text" class="form-control" id="width" name="width">
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    <button style="margin-top:5%" type="submit" class="btn btn-success btn-lg">Submit</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
